...
final class CatsFavoritesBloc extends Bloc<CatsFavoritesEvent, CatsFavoritesState> {
  ...
  void _setUpEventListeners() {
    ...
    on<EditFavoriteCat>(_onEditFavoriteCat);
    on<AddFavoriteCat>(_onAddFavoriteCat);
  ...
  Future _onEditFavoriteCat(
    EditFavoriteCat event,
    Emitter<CatsFavoritesState> emit,
  ) async {
  ...
  Future _onAddFavoriteCat(
    AddFavoriteCat event,
    Emitter<CatsFavoritesState> emit,
  ) async {
    final newState = CatsFavoritesNavigationState(
      route: CommonRoutes.catModifyPackage.value,
